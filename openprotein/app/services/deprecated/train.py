"""
(Deprecated) OpenProtein workflow train interface.
"""

from openprotein.api.deprecated import train
from openprotein.app.models import AssayDataset
from openprotein.app.models.deprecated import WorkflowTrainFuture
...
class TrainingAPI:
    ...
    def create_training_job(
        ...
        return WorkflowTrainFuture.create(
    ...
    def get_training_results(self, job_id: str) -> WorkflowTrainFuture:
        """
