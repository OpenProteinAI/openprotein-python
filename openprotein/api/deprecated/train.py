...
from openprotein.schemas.deprecated import WorkflowCVJob, WorkflowTrainJob
...
def crossvalidate(
    session: APISession, train_job_id: str, n_splits: int = 5
) -> WorkflowCVJob:
    """
...
def _train_job(
    ...
    Parses the response into a `TrainJob` object.
