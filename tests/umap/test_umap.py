...
def test_get_umap(umap_api: UMAPAPI, mock_umap_fit_job):
...
def test_fit_umap(umap_api: UMAPAPI):
    ...
    with patch(
        ...
        with patch("openprotein.umap.models.UMAPModel.create") as mock_model_create:
            umap_api.fit_umap(model=model)
